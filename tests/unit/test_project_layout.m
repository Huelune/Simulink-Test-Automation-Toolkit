...
required = { ...
    ...
    fullfile(rootDir, 'src', 'coverage', ...
        'st_collect_result_coverage_objects.m'), ...
    fullfile(rootDir, 'src', 'coverage', ...
...
function testSpecificationWorkbookHelpersExist(testCase)
rootDir = st_project_root();
required = { ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_collect_specification_rows.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_split_workbook_overflow.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_apply_workbook_wrap_styles.m')};
verifyTrue(testCase, all(cellfun(@isfile, required)));
end

function testFinalDocumentEntryPointsExist(testCase)
rootDir = st_project_root();
required = { ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_export_final_document.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_final_document_run_source.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_final_document_outcomes.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_final_document_coverage.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_final_document_table.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_write_final_document_workbook.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
        'st_final_document_decisions.m'), ...
    fullfile(rootDir, 'src', 'exporting', ...
