...
function testCoverageDescriptorMatchesStandaloneModelRoot(testCase)
descriptors = coverage_descriptors( ...
    "st_h_0001_Harness", "", "", "st_h_0001_Harness");
indices = st_match_coverage_descriptors(descriptors, ...
    'st_h_0001_Harness/ExportedCUT');
