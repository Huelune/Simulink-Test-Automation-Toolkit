...
verifyNotEmpty(testCase, regexp(source, ...
    'Simulink\.ID\.getSID\(rulePaths\{i\}\)', 'once'));
verifyNotEmpty(testCase, regexp(source, ...
...
verifyNotEmpty(testCase, regexp(source, ...
    'find_system\(ownerPath[\s\S]*?''SearchDepth'', 1', 'once'));
verifyNotEmpty(testCase, regexp(source, ...
    'rulePaths\s*=\s*rulePaths\(~strcmp\(rulePaths, ownerPath\)\)', ...
    'once'));
verifyNotEmpty(testCase, regexp(source, ...
    'for i = 1:numel\(rulePaths\)', 'once'));
verifyNotEmpty(testCase, regexp(source, ...
