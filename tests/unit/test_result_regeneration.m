...
directory = fullfile(root,'001_tc_A');
...
item = struct('No',1,'CUTName','A','CUTPath','A/CUT','TestCaseName','tc_A', ...
    ...
    'PackagedCVF',fullfile(directory,'tc_A.cvf'),'CoverageResult',fullfile(directory,'tc_A.cvt'), ...
    'TestReport',directory,'ReportHTML',fullfile(directory,'tc_A.html'), ...
