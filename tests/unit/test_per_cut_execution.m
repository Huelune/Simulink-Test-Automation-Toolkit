...
verifyNotEmpty(testCase, regexp(source, ...
    '''ApplyManagedFiltersDuringRun'', false', 'once'));
verifyNotEmpty(testCase, regexp(source, ...
    'resultFilterFiles\s*=\s*string\(filterFile\)', 'once'));
verifyEmpty(testCase, regexp(source, ...
...
resultFilterPosition = regexp(source, ...
    'st_apply_result_coverage_filters', 'once');
verifyTrue(testCase, runPosition < resultFilterPosition);
...
cvtPosition = regexp(source, ...
    'cvsave\(basePath, coverageObjects\(i\)\)', 'once');
verifyTrue(testCase, copyPosition < resultPosition && ...
    resultPosition < cvtPosition);
end
