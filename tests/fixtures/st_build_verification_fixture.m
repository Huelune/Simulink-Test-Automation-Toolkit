...
ExpectedUpdateMode = ["APPLY"; "APPLY"; "APPLY"; ...
    "APPLY"; "OFF"; "APPLY"];
CoverageFilterMode = ["SUBSYSTEM"; "ALL_CONTENT"; repmat("OFF", 4, 1)];
CoverageBoundaryMode = ["CUT_ONLY"; "CUT_ONLY"; "CUT_ONLY"; ...
    repmat("OFF", 3, 1)];
CoverageFilterAction = ["JUSTIFY"; "EXCLUDE"; strings(4, 1)];
CoverageFilterRationale = ["Verification-only child subsystem"; ...
    "Verification-only nested content"; strings(4, 1)];
...
targets = table(No, Enabled, CUTName, CUTPath, HarnessName, ...
    ...
    CoverageFilterMode, CoverageBoundaryMode, CoverageFilterAction, ...
