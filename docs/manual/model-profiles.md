...
```matlab
st_setup
st_save_model_profile('OBC', ...
    'ModelFile', 'D:\models\OBC\OBC.slx', ...
    'ManagementExcel', 'D:\models\OBC\TestManagement.xlsx', ...
    'ManagementSheet', 'Targets', ...
    'TestFile', 'D:\results\OBC\OBC.mldatx', ...
    'TestSuiteName', 'New Test Suite 1', ...
    'OutputRoot', 'D:\results\OBC', ...
    'StandaloneCoverageRootDir', 'D:\delivery\OBC');
```
