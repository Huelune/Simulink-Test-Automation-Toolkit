...
- Follow `docs/commit-convention.md` when creating or proposing commits: one logical change per commit, Conventional Commits format, and a commit plan presented first when several are needed.
