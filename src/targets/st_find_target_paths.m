...
for dataRow = 1:rowCount
    ...
    % An existing cell whose trailing name carries a single '/' is the same
    % path, just written without the Simulink escaping. Escape it here so
    % the first pass can reuse it instead of reassigning the row.
    currentPath = ...
        char( ...
