...
if any(PreparationFromStage == "COVERAGE_FILTER")
    error('simtest:RemovedPreparationStage', ...
        ['COVERAGE_FILTER is no longer a preparation stage. Change the ' ...
         'PreparationFromStage cell to TEST_MANAGER; coverage filters ' ...
         'are generated by whoever executes.']);
end
