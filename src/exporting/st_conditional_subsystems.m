...
%
% The root is tested as well. A CUT can be an Enabled Subsystem itself, and
% that enable is a branch the CUT owns just as much as one on a child.
%
...
% find_system already reports the root when the root is a Subsystem, but
